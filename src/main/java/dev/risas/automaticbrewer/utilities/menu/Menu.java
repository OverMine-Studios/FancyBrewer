package dev.risas.automaticbrewer.utilities.menu;
...
public abstract class Menu {
    ...
    private Button placeholderButton = Button.placeholder(new ItemBuilder(Material.STAINED_GLASS_PANE)
            .setData(15)
            .setName(" ")
            .build());
    ...
    public void openMenu(Player player, AutomaticBrewer plugin) {
