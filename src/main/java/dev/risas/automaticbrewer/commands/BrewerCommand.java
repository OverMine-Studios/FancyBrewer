package dev.risas.automaticbrewer.commands;
...
import dev.risas.automaticbrewer.utilities.JavaUtil;
import dev.risas.automaticbrewer.utilities.command.BaseCommand;
import dev.risas.automaticbrewer.utilities.command.Command;
import dev.risas.automaticbrewer.utilities.command.CommandArgs;
...
public class BrewerCommand extends BaseCommand {
    ...
    public BrewerCommand(AutomaticBrewer plugin) {
        this.plugin = plugin;
