...
import dev.risas.automaticbrewer.utilities.BukkitUtil;
...
public class BrewerManager {
    ...
    public BrewerManager(AutomaticBrewer plugin) {
    ...
    public void loadBrewerItem() {
        this.brewerItem = new ItemBuilder(Material.BREWING_STAND_ITEM)
